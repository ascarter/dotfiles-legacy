...
GPG_SHA1 = 'f1fd930144720e70bd4c809dd36ac0573b0a7be2'
...
namespace 'gpg' do
	...
	task :install do
	  case RUBY_PLATFORM
	  when /darwin/
  		Bootstrap::MacOSX::Pkg.install(GPG_PKG_NAME, GPG_PKG_IDS[0], GPG_SOURCE_URL, sig: GPG_SHA1)
	  end
	end
	
	desc 'Uninstall gpg'
	task :uninstall do
		Bootstrap::MacOSX::App.run(GPG_UNINSTALL_APP_NAME, GPG_SOURCE_URL, sig: GPG_SHA1)
	end	
end
