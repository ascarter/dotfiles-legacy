...
DOTNET_PKG_NAME = 'dotnet-dev-osx-x64.1.0.0-preview2-003121'.freeze
DOTNET_PKG_IDS = [
...
DOTNET_SOURCE_URL = 'https://go.microsoft.com/fwlink/?LinkID=809124'.freeze
...
namespace 'dotnet' do
  ...
  task :install do
    case RUBY_PLATFORM
    when /darwin/
      Bootstrap::MacOSX::Pkg.install(DOTNET_PKG_NAME,
                                     DOTNET_PKG_IDS[0],
                                     DOTNET_SOURCE_URL)
    end
  end
