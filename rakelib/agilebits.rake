...
ONEPASSWORD_SAFARI_EXTENSION = '1Password-4.5.6'.freeze
ONEPASSWORD_SAFARI_SOURCE_URL = 'https://cache.agilebits.com/dist/1P/ext/1Password-4.5.6.safariextz'.freeze
