...
ONEPASSWORD_SOURCE_URL= 'https://d13itkw33a7sus.cloudfront.net/dist/1P/mac4/1Password-6.3.2.zip'.freeze
ONEPASSWORD_SAFARI_EXTENSION = '1Password-4.5.9'.freeze
ONEPASSWORD_SAFARI_SOURCE_URL = 'https://cache.agilebits.com/dist/1P/ext/1Password-4.5.9.safariextz'.freeze
